...
const val DICTIONARY_FILE = "src/common/dictionary.txt"
val SYMBOLS = CharArray(94) { (0x20 + it).toChar() }.joinToString("")
const val LOWERCASE_LETTERS = "abcdefghijklmnopqrstuvwxyz"
val UPPERCASE_LETTERS = LOWERCASE_LETTERS.toUpperCase()

val MESSAGE = """Alan Mathison Turing was a British mathematician, logician, cryptanalyst, and computer
